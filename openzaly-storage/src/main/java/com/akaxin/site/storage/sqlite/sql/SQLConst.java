...
public interface SQLConst {
	...
	String CREATE_SITE_USER_PROFILE_TABLE = "create table IF NOT EXISTS " + SITE_USER_PROFILE
			+ "(id INTEGER primary key not null, site_user_id VARCHAR(50) UNIQUE NOT NULL, global_user_id VARCHAR(100) UNIQUE NOT NULL, user_id_pubk TEXT UNIQUE, user_name VARCHAR(20), user_photo TEXT, phone_id VARCHAR(20), self_introduce TEXT, apply_info varchar(100), user_status INTEGER, register_time DATETIME);";
	...
	String CREATE_SITE_GROUP_PROFILE_TABLE = "CREATE TABLE IF NOT EXISTS " + SITE_GROUP_PROFILE
			+ "(id INTEGER primary key not null, site_group_id INTEGER UNIQUE NOT NULL, group_name VARCHAR(20), group_photo TEXT, group_notice TEXT, ts_status INTEGER, create_user_id VARCHAR(20), group_status INTEGER, create_time DATETIME);";

	String CREATE_SITE_GROUP_MESSAGE_TABLE = "CREATE TABLE IF NOT EXISTS " + SITE_GROUP_MESSAGE
			+ "(id INTEGER primary key not null, site_group_id VARCHAR(50) not null, msg_id VARCHAR(50), send_user_id VARCHAR(50), msg_type INTEGER, content TEXT, msg_time DATETIME);";
