...
public class SQLiteUserFriendDao {
    ...
    public int getFrienNum(long now, int day) throws SQLException {
        ...
        String sql = "SELECT COUNT(*) FROM " + USER_FRIEND_TABLE + " a," + USER_FRIEND_TABLE + " b WHERE a.add_time < ? and a.site_user_id = b.site_friend_id and b.site_user_id = a.site_friend_id ";
